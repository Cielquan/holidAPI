...
pub_holidays = {
    ...
    "Altweiber": {"wer": "keiner", "wann": OS + timedelta(-52)},
    "Rosenmontag": {"wer": "keiner", "wann": OS + timedelta(-48)},
    "Karfreitag": {"wer": "alle", "wann": OS + timedelta(-2)},
    "Ostersamstag": {"wer": "alle", "wann": OS + timedelta(-1)},
    "Ostersonntag": {"wer": "alle", "wann": OS},
    ...
    "Pfingstsonntag": {"wer": "alle", "wann": OS + timedelta(49)},
